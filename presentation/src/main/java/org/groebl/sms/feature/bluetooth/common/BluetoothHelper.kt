...
object BluetoothHelper  {
    ...
    fun addBluetoothMessage(context: Context, address: String, body: String, sentTime: Long, addToRealm: Boolean = false, asRead: Boolean = false, errorCode: Int,  canUseSubId: Boolean = true, subId: Int = 1) {
        if(addToRealm) {
    ...
    private fun addMessageToInboxAsRead(context: Context, address: String, body: String, sentTime: Long, asRead: Boolean = false, errorCode: Int = 0, canUseSubId: Boolean = true, subId: Int = 1) {
        val values = contentValuesOf(
            ...
            Telephony.Sms.READ to asRead,
            Telephony.Sms.ERROR_CODE to errorCode
        )
    ...
    private fun addMessageToRealmInboxAsRead(context: Context, address: String, body: String, sentTime: Long, asRead: Boolean = false, errorCode: Int = 0, canUseSubId: Boolean = true, subId: Int = 1) {
