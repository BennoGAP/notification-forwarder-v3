...
class Transaction @JvmOverloads constructor(private val context: Context, settings: Settings = Settings()) {
    ...
    companion object {
        ...
        const val MMS_SENT = "org.groebl.sms.MMS_SENT"
        const val EXTRA_CONTENT_URI = "content_uri"
        const val EXTRA_FILE_PATH = "file_path"

        const val NOTIFY_SMS_FAILURE = "org.groebl.sms.NOTIFY_SMS_FAILURE"
        const val MMS_UPDATED = "org.groebl.sms.MMS_UPDATED"
