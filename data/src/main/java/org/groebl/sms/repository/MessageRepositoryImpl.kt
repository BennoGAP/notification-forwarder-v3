...
class MessageRepositoryImpl @Inject constructor(
    ...
    override fun savePart(id: Long): File? {
        ...
        val dir = File(context.getExternalFilesDir("NotificationForwarderPro"), "Media").apply { mkdirs() }
    ...
    private fun getIntentForDelayedSms(id: Long): PendingIntent {
        ...
        return PendingIntent.getBroadcast(context, id.toInt(), intent, PendingIntent.FLAG_UPDATE_CURRENT or PendingIntent.FLAG_MUTABLE)
    }
