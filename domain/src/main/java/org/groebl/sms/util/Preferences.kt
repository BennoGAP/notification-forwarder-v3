...
class Preferences @Inject constructor(
    ...
    val bluetooth_threema_hide_prefix = rxPrefs.getBoolean("bluetoothThreemaHidePrefix", true)
    ...
    val bluetooth_threema_blocked_group = rxPrefs.getStringSet("bluetoothThreemaBlockedGroup", HashSet<String>())
    val bluetooth_threema_blocked_contact = rxPrefs.getStringSet("bluetoothThreemaBlockedContact", HashSet<String>())
